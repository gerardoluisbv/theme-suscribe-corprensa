...
function cps_assets(){
    ...
    wp_enqueue_style("detalle", get_template_directory_uri()."/styles/detalle.css",array(),false,'all');
    ...
    wp_enqueue_script("glider-js","https://cdn.jsdelivr.net/npm/glider-js@1.7.3/glider.min.js",array(), false, 'all' );
